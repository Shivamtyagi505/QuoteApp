...
class _QuoteEditViewState extends State<QuoteEditView> {
  ...
  Widget build(BuildContext context) {
    TextEditingController quoteController = TextEditingController(text: widget.quote.content);
    TextEditingController authorController = TextEditingController(text: widget.quote.author);
